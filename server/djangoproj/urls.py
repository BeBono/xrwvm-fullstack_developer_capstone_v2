...
urlpatterns = [
    ...
    #Thiis path added by mine to populate the DealerCar and DealerMake:
    path(
        route='get_cars',
        view=views.get_cars,
        name ='getcars'
    ...
    #*****Test to retrieve Dealer list. From here we fetch the
    # object dealer in which is the array of "dealer".
    path(
        route='dealerdetail/<int:dealer_id>',
